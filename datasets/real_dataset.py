...
if __name__=='__main__':
    REALDATASET = RealWorldPointsDataset('../data/realscans_data/scannet_v2_chairs_aligned/point_cloud', batch_size=6, npoint=2048,  shuffle=False, split='trainval', random_seed=0)
